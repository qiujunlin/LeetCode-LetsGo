...
public class Functions {
    ...
    static {
        ...
        SQL_FUNCTION_MAP.put("greatCircleAngle", ""); //greatCircleAngle(lon1Deg, lat1Deg, lon2Deg, lat2Deg)计算地球表面两点之间的圆心角使用
        SQL_FUNCTION_MAP.put("pointInEllipses", ""); //pointInEllipses(x, y, x₀, y₀, a₀, b₀,...,xₙ, yₙ, aₙ, bₙ)检查点是否属于至少一个椭圆。
